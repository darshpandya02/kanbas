export default function Lab1() {
    return (
        <div id="wd-lab1">
            ...
            <textarea id="wd-textarea" cols={30} rows={10}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus sodales lorem id nunc maximus fermentum. Sed neque nulla, tristique in nulla et, tincidunt consectetur nibh. Aliquam posuere maximus lacus a ullamcorper.</textarea>
